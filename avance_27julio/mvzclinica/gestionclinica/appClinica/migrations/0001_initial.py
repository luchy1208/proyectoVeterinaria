    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userTipo', models.CharField(choices=[('Administrativo', 'Administrativo'), ('Veterinario', 'Veterinario'), ('Auxiliar', 'Auxiliar'), ('Cliente', 'Cliente')], db_comment='Nombre Tipo de usuario', max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('citVetResultado', models.TextField(db_comment='Resultado de la cita', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('eleSubTipRemNombre', models.CharField(db_comment='Nombre del subtipo de elemento de la remision', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serTipo', models.CharField(choices=[('ServicioBasico', 'ServicioBasico'), ('ServicioBienestar', 'ServicioBienestar'), ('Urgencias', 'Urgencias'), ('OtrosServicios', 'OtrosServicios')], db_comment='tipo de servicio', max_length=17, unique=True)),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipoRemNombre', models.CharField(db_comment='Nombre del tipo de remision', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('masCodigo', models.IntegerField(db_comment='codigo único asignado al registro de la mascota', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hisCliProVacunacion', models.CharField(db_comment='nombre del producto utilizado enla vacunacion', max_length=25)),
                ...
                ('hisCliProEctoparasitos', models.CharField(db_comment='nombre del producto utilizado para control de ectoparasitos', max_length=25)),
                ...
                ('hisCliDiaDiferencial', models.CharField(db_comment='enfermedades posiblemte', max_length=100)),
                ('hisCliDiaPresuntivo', models.CharField(db_comment='El posible diagnostico presuntivo', max_length=50)),
                ('hisCliPronostico', models.CharField(db_comment='La evolucion de la mascota o pronostico', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('ageCitMascota', models.ForeignKey(db_comment='la mascota', on_delete=django.db.models.deletion.PROTECT, to='appClinica.mascota')),
                ('ageCitTipServicios', models.ForeignKey(db_comment='Servicios que ofrece la clinica', on_delete=django.db.models.deletion.PROTECT, to='appClinica.servicios')),
            ],
        ),
    ]
